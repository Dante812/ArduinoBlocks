...
=head2 variablesCreator
  приймає текст з змінними в вигляді рядку
  від сервера та друкує готовий код 
  за допомогою "print();"
=cut
...
=head2 elementsCreator
  приймає текст з елементами в вигляді рядку
  від сервера та друкує готовий код 
  за допомогою "print();"
=cut
sub elementsCreator {
...
=head2 actionsCreator
  приймає текст з функціями в вигляді рядку
  від сервера та друкує готовий код 
  за допомогою "print();"
=cut
sub actionsCreator {
